    ...
    <section id="location" className="py-20 md:py-32 bg-secondary/30">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          {/* Map */}
          <div className="relative w-full overflow-hidden rounded-3xl aspect-[16/11] sm:aspect-[4/3] min-h-[280px] sm:min-h-[360px] lg:aspect-auto lg:h-full lg:min-h-[520px]">
            <iframe
